...
Three functions, including *est_lucid*, *sem_lucid*, & *tune_lucid*, are currently available for model fitting and selection. The model outputs can be summarized and visualized using *summary_lucid* and *plot_lucid* respectively. Predictions could be made with *pred_lucid*.
