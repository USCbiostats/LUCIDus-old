...
This package is an implementation for the novel statistical method proposed in the research paper "Latent Unknown Clustering Integrating Multi-omics Data with Phenotypic Traits (LUCID)^[Under development, citation coming soon]." LUCID improves the subtype classification which leads to better diagnostics as well as prognostics and could be the potential solution for efficient targeted treatments and successful personalized medicine.
